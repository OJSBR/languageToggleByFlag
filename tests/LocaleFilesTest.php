...
/**
 * @file plugins/blocks/languageToggleByFlag/tests/LocaleFilesTest.php
 *
...
class LocaleFilesTest extends TestCase
{
    ...
    public const LOCALES = [
        ...
        'fa', 'fi', 'fr', 'fr_CA', 'gl', 'hr', 'hu', 'hy', 'id', 'it', 'ja',
        'ka', 'mk', 'ms', 'nb_NO', 'nl', 'pl', 'pt', 'pt_BR', 'ro', 'ru', 'sl',
        'sr_Latn', 'sv', 'tr', 'uk', 'vi', 'zh_Hans',
    ];

    /** Locales reviewed by a fluent speaker; every entry of the others is marked fuzzy. */
    public const REVIEWED = ['en', 'pt', 'pt_BR', 'es', 'ca', 'gl', 'fr', 'fr_CA', 'it', 'de', 'nl', 'cs', 'da', 'el', 'eu', 'fa', 'hr', 'ja', 'ro', 'ru', 'sv', 'uk', 'vi'];
    ...
    public function testEveryKeyTheCodeUsesExists(): void
    {
        ...
        preg_match_all('/plugins\.block\.languageToggleByFlag\.[a-zA-Z0-9_.]*[a-zA-Z0-9_]/', $sources, $m);
