...
/**
 * @file plugins/blocks/languageToggleByFlag/tests/run.php
 *
...
define('LANGUAGETOGGLEBYFLAG_STANDALONE_TESTS', true);
...
foreach ($files as $file) {
    require_once $file;
    $class = 'APP\plugins\blocks\languageToggleByFlag\tests\\' . basename($file, '.php');
